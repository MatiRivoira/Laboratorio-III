...
class Usuario implements IBM
{
    ...
    public static function TraerTodos() : ?array {
        try {
            $pdo = new PDO("mysql:host=localhost;dbname=usuarios_test", "root", "");
            $sql = $pdo->prepare("SELECT usuarios.id, usuarios.nombre, usuarios.correo, usuarios.clave, usuarios.id_perfil, perfiles.descripcion AS descripcion FROM usuarios
