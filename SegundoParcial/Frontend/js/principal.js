...
$(document).ready(function () {
    ...
    function ListarJuguetesBD() {
        ...
        $.ajax({
            ...
            if (obj_rta.exito == undefined) {
                let tabla = '<table class="table transparent table-hover" style="color: white;">';
    ...
    function MostrarForm(accion, obj_prod = null) {
        ...
        let marca = "";
        let precio = "";
        let path = URL_BASE + "img/toy_default.jpeg";
        if (obj_prod !== null) {
            id = obj_prod.id;
        ...
        let form = '<h3 style="padding-top:1em; text-align: center;">' + encabezado + '</h3>\
