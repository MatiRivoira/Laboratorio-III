...
app.get("/productos_db", (request: any, response: any) => {
    request.getConnection((error:any, conn:any) => {
        if (error) {
            throw ("Ha ocurrido un error al conectarse a la base de datos");
        }
        conn.query("SELECT * FROM productos", (error:any, resultado:any) => {
            if (error) {
...
app.post('/productos_db', upload.single("foto"), (request:any, response:any)=>{
    ...
    request.getConnection((error:any, conexion:any) => {
        ...
        conexion.query("INSERT INTO productos SET ?", [obj], (error:any, resultado:any) => {
            if (error) {
...
app.put('/productos_db', upload.single("foto"), (request:any, response:any)=>{
    ...
    request.getConnection((error:any, conexion:any) => {
        ...
        conexion.query("UPDATE productos SET ? WHERE codigo=?", [obj_modif, obj.codigo], (error:any, resultado:any) => {
            if (error) {
                throw ("Ocurrio un error al generar la consulta");
            }
...
app.delete('/productos_db', (request:any, response:any)=>{
    ...
    request.getConnection((error:any, conexion:any) => {
        ...
        conexion.query("SELECT path FROM productos WHERE codigo=?", [obj.codigo], (error:any, resultado:any) => {
            if (error) {
                throw ("Ocurrio un error al generar la consulta");
            }
    ...
    request.getConnection((error:any, conexion:any) => {
        ...
        conexion.query("DELETE FROM productos WHERE codigo=?", [obj.codigo], (error:any, resultado:any) => {
            if (error) {
                throw ("Ocurrio un error al generar la consulta");
            }
            fs.unlink(path_foto, (error:any) => {
                if (error) {
